...
const { martsRepository, addressRepository } = repositories
...
export const serializers = { 
    martPrivateView: MakeMartPrivateView(addressRepository)
}
...
export const signUpMartController = new SignUpMartController(addressValidator, createAddress, createMart, fileRepository)
...
export const removeMartController = new RemoveController(martsRepository, addressRepository, fileRepository)
